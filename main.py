...
from src.devxOsintgram import devxOsintgram
import argparse
...
def printlogo():
    ...
    pc.printout("\nVersion 1.1 - Developed by daowd romany\n\n", pc.YELLOW)
...
parser = argparse.ArgumentParser(description='devxOsintgram is a Dev-x-OSINT tool on Instagram. It offers an interactive shell '
...
api = devxOsintgram(args.id, args.file, args.json, args.command, args.output, args.cookies)
